...
int main(int argc, char const *argv[])
{
    ...
    desc.add_options()
        ...
        ("row-mult2", po::value<float>()->default_value(0.72), "maximum rows balanced multiplier level 2")
        ("row-mult3", po::value<float>()->default_value(0.30), "maximum rows balanced multiplier level 3")
